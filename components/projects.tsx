...
export default function Projects() {
  return (
    <section className=' py-16 md:py-24 px-6 md:px-12' id='projects'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
          <div className='bg-white rounded-lg shadow-md overflow-hidden'>
            <Image
              ...
              height={300}
              src='https://plus.unsplash.com/premium_photo-1682092618317-9b50d60e6e0d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
              style={{
                aspectRatio: '500/300',
                objectFit: 'cover',
              }}
